...
import getCustomSplitNodeInfo from "./getCustomSplitNodeInfo";

const defaultCustomNodeInfo = {
  isStart: false,
  isEnd: false,
  start: 0,
  end: 0,
};
const getSelectedInfo = ({ range, noteContainer }) => {
  const {
  ...
  let isEnd = false;
  const list = [];
  let customNodeInfo = defaultCustomNodeInfo;
